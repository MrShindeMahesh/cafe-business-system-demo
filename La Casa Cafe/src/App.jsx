...
import UpiQuick from './pages/admin/UpiQuick';
        ...
        <BrowserRouter>
          <Routes>
            ...
            >
              ...
              <Route path="parcel" element={<Protected authKey="parcel"><Parcel /></Protected>} />
              <Route path="bookings" element={<Protected authKey="bookings"><Bookings /></Protected>} />
              ...
              <Route path="expenses" element={<Protected authKey="expenses"><Expenses /></Protected>} />
              <Route path="staff" element={<Protected authKey="staff"><Staff /></Protected>} />
              <Route path="upi-qr" element={<Protected authKey="upi-qr"><UpiQuick /></Protected>} />
            </Route>
