...
export default function CustomerTracking() {
  ...
  // Pull settings to display the dynamic Cafe Name and Tax Rate
    ...
    <div className="tracking-page">
      ...
      <div className="tracking-body">
        ...
        <div className="order-summary animate-slide-up" style={{ animationDelay: '.2s' }}>
          ...
          {/* ----- NEW: SUB TOTAL AND GST BREAKDOWN ----- */}
          <div style={{ marginTop: '1rem', paddingTop: '1rem', borderTop: '1px solid var(--color-border)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '.875rem', color: 'var(--color-text-secondary)', marginBottom: '.5rem' }}>
              <span>Subtotal</span>
