                              ...
                              <hr style={{ border: 'none', borderTop: '1px solid var(--color-border)', margin: '1rem 0' }} />
                               ...
                               <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                                 ...
                                 <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem', flex: 1, background: 'var(--color-bg)', padding: '.4rem .5rem', borderRadius: 'var(--radius-sm)', border: '1px solid var(--color-border)' }}>
                                   <input type="text" value={localSettings.billPrefix || 'LB'} onChange={e => setLocalSettings({ ...localSettings, billPrefix: e.target.value || 'LB' })} placeholder="LB" style={{ width: '60px', padding: '.35rem .4rem', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-sm)', fontSize: '1rem', fontWeight: 700, color: 'var(--color-primary)', textAlign: 'center', letterSpacing: '.1em' }} />
                                   <input type="number" min="1" max="10" value={localSettings.billPadding || 4} onChange={e => setLocalSettings({ ...localSettings, billPadding: Number(e.target.value) || 4 })} style={{ width: '50px', padding: '.35rem .4rem', border: '1px solid var(--color-border)', borderRadius: 'var(--radius-sm)', fontSize: '1rem', fontWeight: 700, textAlign: 'center', background: 'var(--color-bg)' }} />
                                   <span style={{ fontSize: '.7rem', color: 'var(--color-text-muted)' }}>digits (e.g. 4 = 0001)</span>
                                 </div>
                               </div>
