...
import { Coffee, LayoutDashboard, UtensilsCrossed, Grid, Settings, LogOut, FileText, PieChart, Users } from 'lucide-react';
import './Admin.css';
    ...
    <div className="admin-layout animate-fade-in">
      <aside className="admin-sidebar">
        <div className="sidebar-logo">
          ...
          <span className="sidebar-logo-text">Brew & Bite</span>
        </div>
